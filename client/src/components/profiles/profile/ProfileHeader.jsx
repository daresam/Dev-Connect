                ...
                <div className="row">
                    ...
                    <div className="card card-body bg-info text-white mb-3">
                        ...
                        <div className="col-4 col-md-3 m-auto">
                            <img className="rounded-circle" src={profile.user ? profile.user.avatar : ''} alt="" />
                        </div>
                        </div>
                        <div className="text-center">
                        <h1 className="display-4 text-center">{profile.user.name}</h1>
                        <p className="lead text-center">{profile.status} at {isEmpty(profile.company) ? null : profile.company} </p>
